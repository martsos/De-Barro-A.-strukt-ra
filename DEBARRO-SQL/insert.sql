INSERT INTO core_dim_ceg (ceg_nev, tulajdonos_neve) VALUES 
('De Barro Kft.', 'Sáry László Endre'),
('SC-Invest Kft.', 'Sáry László Endre'),
('AVIA', 'AVIA');

INSERT INTO core_dim_lokacio (lokacio_nev)
VALUES ('Tata - Magdolna');

INSERT INTO ua_dim_fogyoanyag (anyag_megnevezes, tulajdonos_id, anyag_kategoria)
...
INSERT INTO core_dim_munkaero (
    foglalkoztatott_nev, foglalkoztato_id,
    foglalkoztatas_tipusa, munkaora
)
VALUES ('Sáry László Endre', 1, 'teljes munkaidős', 8);

INSERT INTO ua_dim_keszlet (tartaly_id, aktualis_liter)
SELECT tartaly_id, 0 FROM ua_dim_tartaly;
