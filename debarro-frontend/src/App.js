...
import { ConfigProvider, theme, Form, Select, DatePicker, InputNumber, Input, Button, Card, Alert, Typography } from "antd";
...
function App() {
  ...
  return (
    <ConfigProvider theme={{ algorithm: theme.darkAlgorithm }}>
      <div style={{ minHeight: "100vh", background: "#141414", padding: "40px 20px" }}>
